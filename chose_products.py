from items import ProductInventory
import typer
...
class ShopInterface:
    ...
    def confirm_order(self, product_info, final_price):
        rprint(f"\nTu pedido de helado de [bold yellow]{product_info['product_name']}[/bold yellow ] con un precio de [bold green]${final_price:.2f}[/bold green] está casi listo.")
